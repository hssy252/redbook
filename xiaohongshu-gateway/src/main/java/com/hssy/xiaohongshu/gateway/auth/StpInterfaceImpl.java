...
public class StpInterfaceImpl implements StpInterface {
            ...
            if (CollUtil.isNotEmpty(rolePermissionsValues)) {
                ...
                rolePermissionsValues.forEach(jsonValue -> {
                    try {
                        ...
                        List<String> rolePermissions = objectMapper.readValue((String) jsonValue, new TypeReference<>() {});
    ...
    public List<String> getRoleList(Object loginId, String loginType) {
        ...
        // 返回此 loginId 拥有的角色列表
        // 从 redis 获取
        String key = RedisKeyConstants.buildUserRoleKey(Long.parseLong((String) loginId));
        String roles = (String)redisTemplate.opsForValue().get(key);
        ...
        try {
            Object value = objectMapper.readValue(roles, new TypeReference<>() {
            });
            return (List<String>) value;
        } catch (JsonProcessingException e) {
            log.error("用户{}对应权限解析错误",loginId);
